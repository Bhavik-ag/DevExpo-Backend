...
class LoginTestCase(APITestCase):
    def setUp(self):
        self.user = User.objects.create_user(
            username="testcase", password="dummypassword", email="test@gmail.com"
        )
        self.user.profile = Profile.objects.create(user=self.user)

    def test_username_login(self):
        data = {"username": "testcase", "password": "dummypassword"}
    ...
    def test_email_login(self):
        data = {"username": "test@gmail.com", "password": "dummypassword"}
    ...
    def test_wrong_password(self):
        data = {"username": "testcase", "password": "wrongpassword"}
    ...
    def test_wrong_username(self):
        data = {"username": "wrongusername", "password": "dummypassword"}
...
class ProfileTestCase(APITestCase):
    ...
    def test_profile_update_unauthenticated(self):
        ...
        response = self.client.patch(
            reverse("profile-update", kwargs={"username": self.user.username}), data
        )
    ...
    def test_profile_update_by_random_user(self):
        random_user = User.objects.create_user(
            username="randomuser",
            password="dummypassword",
            email="random@devexpo.com",
            first_name="random",
            last_name="user",
        )
        random_user.profile = Profile.objects.create(user=random_user)

        randome_user_token = RefreshToken.for_user(random_user).access_token
        self.client.credentials(HTTP_AUTHORIZATION="Bearer " + str(randome_user_token))

        response = self.client.patch(
            reverse("profile-update", kwargs={"username": self.user.username}),
            {"bio": "This is a updated test bio"},
        )
